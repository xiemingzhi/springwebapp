...
public class RESTAuthenticationFilter extends AbstractAuthenticationProcessingFilter {
    ...
    private String decodeParameterValue(HttpServletRequest request, String requestParameterName) throws UnsupportedEncodingException {
        ...
        return URLDecoder.decode(getParameterValue(request, requestParameterName), encoding)
                .replaceAll(" ", "+");
    }

    private String getParameterValue(HttpServletRequest request, String requestParameterName) {
    	System.out.println("requestparametername;"+requestParameterName);
    	Enumeration<String> params = request.getParameterNames();
    	while( params.hasMoreElements()) {
    		String theparam = params.nextElement();
    		System.out.println("from request;"+theparam);
    		System.out.println("param value;"+request.getParameter(theparam));
    	}
