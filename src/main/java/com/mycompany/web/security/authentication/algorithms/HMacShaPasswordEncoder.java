package com.mycompany.web.security.authentication.algorithms;
...
public class HMacShaPasswordEncoder implements PasswordEncoder {
    ...
    public static void main(String args[]) {
    	HMacShaPasswordEncoder hspe = new HMacShaPasswordEncoder(256, true);
    	System.out.println(hspe.encodePassword("password", "mysalt"));
    }
}
